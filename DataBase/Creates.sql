...
CREATE TABLE PROFESSORES(
	...
	ID_USUARIO INT FOREIGN KEY REFERENCES USUARIOS(ID) UNIQUE NOT NULL,
	ID_AREA INT FOREIGN KEY REFERENCES EQUIPES(EQUIPE_ID) NOT NULL
);
...
CREATE TABLE EQUIPES(
	...
	EQUIPE VARCHAR(200) UNIQUE NOT NULL,
)
...
CREATE TABLE PROJETOS(
	...
	ID_PROFESSOR INT FOREIGN KEY REFERENCES PROFESSORES(PROFESSOR_ID) NOT NULL
)
